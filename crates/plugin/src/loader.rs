...
const PLUGIN_FACTORY_SYMBOL: &[u8] = b"_plugin_create";

/// Symbol name for the plugin metadata function
const PLUGIN_METADATA_SYMBOL: &[u8] = b"_plugin_metadata";
...
/// Usage:
/// ```ignore
/// plugin::declare_plugin!(MyPlugin);
/// ```
#[macro_export]
macro_rules! declare_plugin {
    ($plugin_type:ty) => {
        #[no_mangle]
        pub extern "C" fn _plugin_create() -> Box<dyn $crate::Plugin> {
